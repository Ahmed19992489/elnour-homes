...
export default function Home() {
  ...
  UpdateHead({
    title: lang === "ar" ? "النور هوم (Elnour Home) - أثاث وديكورات استيل فاخرة | طرابيزات وفواصل" : "Elnour Home - Luxury Steel & Modern Furniture | Tables & Dividers",
    description: lang === "ar" ? "أعمال أثاث وديكور منزلي فاخر من الاستيل: طرابيزات، كونسول، فواصل، ومرايات مضيئة. اطلب أونلاين مع توصيل لكافة المحافظات." : "Luxury home decor and modern furniture crafted from steel: tables, dividers, light channels and wall decor. Order online with delivery across Egypt.",

// سعر المتر المربع للبراويز والطابوهات (ج.م/م²) — يُعدّل من الإعدادات لاحقًا
export const SQM_PRICE_EGP = 3000;
...
// Domain), preventing sibling subdomains from planting matching values.
